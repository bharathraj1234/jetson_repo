...
# Specify the path to the haarcascades directory
haarcascades_path = '/usr/lib/python3/dist-packages/data/haarcascades/'

# Use the path in CascadeClassifier
...
# Specify the path for the full-body cascade
